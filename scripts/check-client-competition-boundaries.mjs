...
for (const [name,text,own,forbidden] of [
  ['summary', summary, ['getMyDogCompetition'], ['getMyOfficialExamDetail','getMyConstancyDetail','getCompetitionLeaderboard']],
  ['exam', exam, ['getMyOfficialExamDetail'], ['getMyDogCompetition','getMyConstancyDetail','getCompetitionLeaderboard']],
  ['constancy', constancy, ['getMyConstancyDetail'], ['getMyDogCompetition','getMyOfficialExamDetail','getCompetitionLeaderboard']],
  ['ranking', ranking, ['getCompetitionLeaderboard'], ['getMyDogCompetition','getMyOfficialExamDetail','getMyConstancyDetail']],
]) {
