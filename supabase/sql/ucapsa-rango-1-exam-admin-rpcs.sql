...
-- La estructura queda congelada al publicar el examen. Como defensa adicional,
-- tampoco puede mutar si existieran intentos reviewed/published; con resultados
-- draft, max_points no puede bajar por debajo de un valor ya capturado.
