-- UCAPSA Rango 1 — season-aware exam structure guard.
--
-- Publishing already freezes exam structure. This hardens the same database
-- trigger so draft structure can only change while its competition season is
-- mutable, including direct table writes and item moves.
