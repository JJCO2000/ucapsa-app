-- Align Continuity with the canonical account deletion workflow.
-- The observation column names stay stable for app compatibility, but the
-- source is account_deletion_requests instead of membership_delete_requests.
