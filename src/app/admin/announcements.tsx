  ...
  return (
    <KeyboardAwareScreen>
      <View style={styles.hero}>
        ...
        <Pressable style={styles.addButton} onPress={openNew}><MaterialIcons name="add" size={21} color="#fff" /><Text style={styles.addText}>Nuevo</Text></Pressable>
      </View>
...
const styles = StyleSheet.create({
  ...
  choice: { borderRadius: 999, borderWidth: 1, borderColor: '#F3B8C2', backgroundColor: '#fff', paddingHorizontal: 10, paddingVertical: 8 },
  ...
  dateButton: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 14, backgroundColor: '#fff', padding: 11 },
  ...
  eventPicker: { flexDirection: 'row', alignItems: 'center', gap: 8, borderRadius: 12, backgroundColor: '#FFF8F8', padding: 10, marginTop: 5 },
  optionText: { color: ucapsaBrand.colors.muted, fontSize: 11, fontWeight: '800', marginTop: 2 },
  eventList: { gap: 5, borderRadius: 12, backgroundColor: '#FFF8F8', padding: 8 },
  inputLight: { borderRadius: 11, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', paddingHorizontal: 10, paddingVertical: 9, color: ucapsaBrand.colors.text },
  eventRow: { borderRadius: 10, backgroundColor: '#fff', padding: 9 },
