      ...
      {record ? (
        <>
          ...
          <View style={styles.card}>
            ...
            <MenuRow icon="badge" title="Membresia" subtitle="Estado, vigencia y numero de socio" section="membership" userId={userId} />
...
const styles = StyleSheet.create({
  ...
  error: { borderRadius: 18, borderWidth: 1, borderColor: '#FECACA', backgroundColor: '#FEF2F2', padding: 16, gap: 8 },
  ...
  heroSubtitle: { color: '#FFE8EC', fontSize: 13, marginTop: 4, fontWeight: '700' },
  ...
  metric: { width: '48%', borderRadius: 16, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', padding: 12 },
