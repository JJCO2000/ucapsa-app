  ...
  return (
    <KeyboardAwareScreen>
      ...
      <View style={styles.card}>
        ...
        {isSuperAdmin ? <Row icon="gavel" title="Aviso de privacidad" subtitle="Versiones, borradores y publicación del aviso canónico" onPress={() => router.push('/admin/privacy-notices' as never)} /> : null}
