...
const styles = StyleSheet.create({
  ...
  dateButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', borderRadius: 18, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', padding: 14 },
  ...
  activityBody: { gap: 8, borderRadius: 16, backgroundColor: '#fff', borderWidth: 1, borderColor: ucapsaBrand.colors.border, padding: 12, marginBottom: 10 },
  ...
  classList: { gap: 7 },
  classRow: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 15, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', padding: 12 },
  classRowSelected: { borderColor: ucapsaBrand.colors.red, backgroundColor: '#FFF2F4' },
  radio: { width: 17, height: 17, borderRadius: 9, borderWidth: 2, borderColor: '#C7A7AD' },
  ...
  emptyCard: { gap: 5, borderRadius: 17, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', padding: 14 },
  ...
  input: { borderRadius: 15, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', paddingHorizontal: 12, paddingVertical: 11, color: ucapsaBrand.colors.text },
  ...
  cancelButtonText: { color: '#fff', fontSize: 13, fontWeight: '900' },
  cancelAllButton: { alignItems: 'center', borderRadius: 15, borderWidth: 1, borderColor: '#E5A2AE', backgroundColor: '#fff', paddingVertical: 12, marginTop: 7 },
  cancelAllText: { color: ucapsaBrand.colors.redDark, fontSize: 12, fontWeight: '900' },
  disabled: { opacity: 0.48 },
  sectionBlock: { marginTop: 8 },
  cancellationRow: { flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 15, borderWidth: 1, borderColor: ucapsaBrand.colors.border, backgroundColor: '#fff', padding: 12, marginBottom: 7 },
  ...
  deleteButton: { borderRadius: 10, borderWidth: 1, borderColor: '#E5A2AE', paddingHorizontal: 9, paddingVertical: 7 },
